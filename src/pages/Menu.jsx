...
import { ShoppingCart, Plus, Search, X, Minus } from 'lucide-react';
                  ...
                  {p.imagen ? (
                    <div style={{ position: 'relative' }}>
                      ...
                      <div style={{
                        ...
                        height: 48,
                        background: 'linear-gradient(to top, rgba(26,17,11,0.7), transparent)',
                      }} />
                    </div>
                  ) : (
                    <div style={{
                      ...
                      {inCart ? (
                        <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
                          ...
                          <button
                            ...
                            style={{
                              ...
                              display: 'flex', alignItems: 'center', justifyContent: 'center',
                              border: 'none',
                              boxShadow: '0 2px 8px rgba(207,100,48,0.3)',
                            }}
                          >
                        ...
                        <button
                          ...
                          style={{
                            ...
                            boxShadow: '0 2px 8px rgba(207,100,48,0.25)',
                            transition: 'box-shadow 0.18s',
                          }}
                          onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 4px 14px rgba(207,100,48,0.4)'; }}
                          onMouseLeave={e => { e.currentTarget.style.boxShadow = '0 2px 8px rgba(207,100,48,0.25)'; }}
                        >
      ...
      {items.length > 0 && (
        <div
          ...
          style={{
            ...
            background: 'linear-gradient(135deg, var(--accent), var(--accent-dim))',
            color: '#f0e4d2',
            padding: '14px 28px', borderRadius: 44,
        ...
        >
          <div style={{
            background: 'rgba(0,0,0,0.25)', color: '#f0e4d2',
